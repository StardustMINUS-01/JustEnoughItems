...
class IngredientListOverlayController {
	...
	void init() {
		this.searchField.setSearchText(this.filterTextSource.getFilterText());
		this.searchField.setSearchFieldFocused(false);
	...
	private void onFilterTextChanged(String oldFilterText, String newFilterText) {
		this.searchField.setSearchText(newFilterText);
