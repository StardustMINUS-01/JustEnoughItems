 ...
 * Ported from JEI 1.21.1 (BookmarkOverlayInputHandlers.java), adapted to the 1.20.1 hotkey router
 * (the 1.20.1 PacketRequestCheatPermission constructor) and the full 1.21.1 group-panel drag
