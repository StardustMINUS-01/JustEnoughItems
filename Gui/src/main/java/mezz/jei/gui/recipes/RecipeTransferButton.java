...
public class RecipeTransferButton extends GuiIconToggleButton {
	...
	protected void getTooltips(JeiTooltip tooltip) {
		...
		boolean hasVanillaOverlayTarget = parentContainer != null && !BookmarkGhostOverlayTargetSlots.fromMenu(parentContainer).isEmpty();
		if (hasVanillaOverlayTarget) {
			RecipeButtonHotkeyTooltipUtil.addOverlayButtonHotkeys(
				tooltip,
