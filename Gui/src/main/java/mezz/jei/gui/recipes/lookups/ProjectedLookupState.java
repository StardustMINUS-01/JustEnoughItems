...
public final class ProjectedLookupState implements ILookupState {
	...
	public void nextRecipeCategory() {
		...
		moveToRecipeCategoryIndex((recipeCategoryIndex + 1) % projectedRecipes.size());
	}
	...
	public void previousRecipeCategory() {
		...
		moveToRecipeCategoryIndex((projectedRecipes.size() + recipeCategoryIndex - 1) % projectedRecipes.size());
	}
