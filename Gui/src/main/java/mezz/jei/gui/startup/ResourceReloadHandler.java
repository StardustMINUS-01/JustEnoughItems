...
public class ResourceReloadHandler implements ResourceManagerReloadListener {
	...
	public ResourceReloadHandler(IngredientListOverlay ingredientListOverlay, IngredientFilter ingredientFilter, Runnable cacheInvalidator) {
	...
	public void onResourceManagerReload(ResourceManager resourceManager) {
		...
		// 1.21.1 parity: force the update, otherwise the unchanged screen properties skip the
		// onChanged callback and the overlay keeps the pre-reload element layout.
