...
public class RecipeChainIteratorTest {
	...
	private static final ResourceLocation STICK_RECIPE = new ResourceLocation("test", "stick");
	private static final ResourceLocation TABLE_RECIPE = new ResourceLocation("test", "table");
	private static final ResourceLocation TORCH_RECIPE = new ResourceLocation("test", "torch");
