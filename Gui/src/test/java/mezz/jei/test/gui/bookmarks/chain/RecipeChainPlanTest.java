...
public class RecipeChainPlanTest {
	...
	private static final ResourceLocation PLATE = new ResourceLocation("test", "plate");
	private static final ResourceLocation MACHINE = new ResourceLocation("test", "machine");
