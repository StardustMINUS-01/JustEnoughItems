...
public final class ClientConfig implements IClientConfig {
	...
	private final ConfigValue<Boolean> copyFullComponentsEnabled;
	...
	public ClientConfig(IConfigSchemaBuilder schema) {
		...
		copyFullComponentsEnabled = input.addBoolean("copyFullComponents", false);
	...
	@Override
	public ConfigValue<Boolean> showRecipeHandlerIconEnabled() {
		return showRecipeHandlerIconEnabled;
	}

	@Override
	public ConfigValue<Integer> favoriteTreeDepth() {
	...
	@Override
	public ConfigValue<Boolean> copyFullComponentsEnabled() {
