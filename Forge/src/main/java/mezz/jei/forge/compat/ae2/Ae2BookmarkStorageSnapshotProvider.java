...
/**
 * Reads the open AE2 terminal's client-side network repository (client repo), so bookmark pull and
 * auto-crafting can see items stored in the ME network. Reflection-based so JEI never hard-depends on AE2.
 */
